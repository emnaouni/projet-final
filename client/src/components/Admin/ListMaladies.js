...
import { getmaladies ,deletemaladies } from "../../actions/ListMaladiesActions"
...
export default compose(withStyles(styles), connect(MapStateToProps, {getmaladies ,deletemaladies}))(ListMaladies);